...
const partyData2 = [
  {
    icon: <FaCocktail className="text-3xl" />, // Bachelorette icon
    label: "Bachelorette",
  },
  {
    icon: <FaGlassCheers className="text-3xl" />, // Bachelor party icon
    label: "Bachelor",
  },
  {
    icon: <FaBirthdayCake className=" text-3xl" />, // Birthday icon
    label: "Birthday",
  },
  {
    icon: <FaUsers className=" text-3xl" />, // Group trip icon
    label: "Group trip",
  },
  {
    icon: <FaLaughBeam className="text-3xl" />, // Just a Good Time icon
    label: "Just a Good Time",
  },
  {
    icon: <FaGlassCheers className="text-3xl" />, // Bachelor party icon
  ...
  <div className="flex flex-col lg:flex-row items-center p-4 text-center">
    <h2 className="text-2xl font-semibold mb-6 lg:mb-0 lg:mx-12">
      What’s the Party?
    </h2>
    <div className="flex flex-wrap justify-center gap-4 font-[Mulish]">
      {partyData.map((item, index) => (
        <div
          key={index}
          className="relative flex flex-col items-center bg-black text-white border rounded-lg shadow-md w-40 sm:w-44 p-4"
        >
          
          <img
            src={item.imgSrc}
            alt={item.label}
            className="h-[70px] w-[70px] hover:h-[73px] hover:w-[73px] cursor-pointer absolute -top-10"
          />
